...
func (c *FirestoreConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"firestore.delete": makeParamValidator[deleteParams](),
	"firestore.get": makeParamValidator[getParams](),
	"firestore.query": makeParamValidator[queryParams](),
	"firestore.set": makeParamValidator[setParams](),
	"firestore.update": makeParamValidator[updateParams](),
}
