...
func (c *DropboxConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"dropbox.create_folder": makeParamValidator[createFolderParams](),
	"dropbox.download_file": makeParamValidator[downloadFileParams](),
	"dropbox.move": makeParamValidator[moveParams](),
	"dropbox.search": makeParamValidator[searchParams](),
	"dropbox.share_file": makeParamValidator[shareFileParams](),
	"dropbox.upload_file": makeParamValidator[uploadFileParams](),
}
