...
func (c *RedisConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"redis.delete": makeParamValidator[deleteParams](),
	"redis.get": makeParamValidator[getParams](),
	"redis.lpop": makeParamValidator[popParams](),
	"redis.lpush": makeParamValidator[pushParams](),
}
