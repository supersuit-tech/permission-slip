...
func (c *PostgresConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"postgres.delete": makeParamValidator[deleteParams](),
	"postgres.insert": makeParamValidator[insertParams](),
	"postgres.query": makeParamValidator[queryParams](),
	"postgres.update": makeParamValidator[updateParams](),
}
