...
func TestAdjustInventory_MissingParams(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "non-numeric quantity", params: `{"catalog_object_id":"I","location_id":"L","quantity":"abc","from_state":"NONE","to_state":"IN_STOCK"}`},
		{name: "zero quantity", params: `{"catalog_object_id":"I","location_id":"L","quantity":"0","from_state":"NONE","to_state":"IN_STOCK"}`},
		{name: "negative quantity", params: `{"catalog_object_id":"I","location_id":"L","quantity":"-5","from_state":"NONE","to_state":"IN_STOCK"}`},
