...
func (c *DynamoDBConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"dynamodb.delete_item": makeParamValidator[deleteItemParams](),
	"dynamodb.get_item": makeParamValidator[getItemParams](),
	"dynamodb.put_item": makeParamValidator[putItemParams](),
	"dynamodb.query": makeParamValidator[queryParams](),
}
