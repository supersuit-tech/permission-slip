...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	...
	"github.close_pr":              makeParamValidator[closePRParams](),
	"github.delete_branch":         makeParamValidator[deleteBranchParams](),
	"github.delete_file":           makeParamValidator[deleteFileParams](),
	"github.delete_webhook":        makeParamValidator[deleteWebhookParams](),
	"github.get_issue":             makeParamValidator[getIssueParams](),
	"github.get_pr":                makeParamValidator[getPRParams](),
	"github.list_commits":          makeParamValidator[listCommitsParams](),
	"github.list_issues":           makeParamValidator[listIssuesParams](),
	"github.remove_label":          makeParamValidator[removeLabelParams](),
	"github.remove_reviewer":       makeParamValidator[removeReviewerParams](),
	"github.update_issue":          makeParamValidator[updateIssueParams](),
	"github.update_pr":             makeParamValidator[updatePRParams](),
}
