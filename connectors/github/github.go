...
func (c *GitHubConnector) Actions() map[string]connectors.Action {
	return map[string]connectors.Action{
		...
		"github.delete_branch":         &deleteBranchAction{conn: c},
		"github.delete_file":           &deleteFileAction{conn: c},
		"github.remove_label":          &removeLabelAction{conn: c},
		"github.close_pr":              &closePRAction{conn: c},
		"github.update_issue":          &updateIssueAction{conn: c},
		"github.update_pr":             &updatePRAction{conn: c},
		"github.get_issue":             &getIssueAction{conn: c},
		"github.get_pr":                &getPRAction{conn: c},
		"github.list_issues":           &listIssuesAction{conn: c},
		"github.list_commits":          &listCommitsAction{conn: c},
		"github.remove_reviewer":       &removeReviewerAction{conn: c},
		"github.delete_webhook":        &deleteWebhookAction{conn: c},
