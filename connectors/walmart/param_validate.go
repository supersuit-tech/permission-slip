...
func (c *WalmartConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"walmart.get_product": makeParamValidator[getProductParams](),
	"walmart.search_products": makeParamValidator[searchProductsParams](),
}
