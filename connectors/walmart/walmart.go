...
// Consumer ID + key version header authentication. No third-party SDK —
// plain net/http.
package walmart
...
// non-empty consumer_id. key_version defaults to "1" if omitted.
// impact_id is optional (used for affiliate link attribution).
