...
func (c *AWSConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"aws.create_presigned_url": makeParamValidator[createPresignedURLParams](),
	"aws.describe_instances": makeParamValidator[describeInstancesParams](),
	"aws.describe_rds_instances": makeParamValidator[describeRDSParams](),
	"aws.get_metrics": makeParamValidator[getMetricsParams](),
	"aws.list_s3_objects": makeParamValidator[listS3ObjectsParams](),
	"aws.restart_instance": makeParamValidator[instanceIDParams](),
}
