...
func (c *MySQLConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"mysql.delete": makeParamValidator[deleteParams](),
	"mysql.insert": makeParamValidator[insertParams](),
	"mysql.query": makeParamValidator[queryParams](),
	"mysql.update": makeParamValidator[updateParams](),
}
