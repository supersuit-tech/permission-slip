...
func (c *DoorDashConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"doordash.cancel_delivery": makeParamValidator[cancelDeliveryParams](),
	"doordash.create_delivery": makeParamValidator[createDeliveryParams](),
	"doordash.get_delivery": makeParamValidator[getDeliveryParams](),
	"doordash.get_quote": makeParamValidator[getQuoteParams](),
	"doordash.list_deliveries": makeParamValidator[listDeliveriesParams](),
}
