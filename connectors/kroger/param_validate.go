...
func (c *KrogerConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"kroger.add_to_cart": makeParamValidator[addToCartParams](),
	"kroger.get_product": makeParamValidator[getProductParams](),
	"kroger.search_locations": makeParamValidator[searchLocationsParams](),
	"kroger.search_products": makeParamValidator[searchProductsParams](),
}
