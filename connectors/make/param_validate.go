...
func (c *MakeConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"make.get_scenario": makeParamValidator[getScenarioParams](),
	"make.list_executions": makeParamValidator[listExecutionsParams](),
	"make.list_scenarios": makeParamValidator[listScenariosParams](),
	"make.run_scenario": makeParamValidator[runScenarioParams](),
	"make.toggle_scenario": makeParamValidator[toggleScenarioParams](),
}
