...
func (c *MongoDBConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"mongodb.delete": makeParamValidator[deleteParams](),
	"mongodb.find": makeParamValidator[findParams](),
	"mongodb.insert": makeParamValidator[insertParams](),
	"mongodb.update": makeParamValidator[updateParams](),
}
