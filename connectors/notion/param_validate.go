...
func (c *NotionConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"notion.append_blocks": makeParamValidator[appendBlocksParams](),
	"notion.create_page": makeParamValidator[createPageParams](),
	"notion.query_database": makeParamValidator[queryDatabaseParams](),
	"notion.search": makeParamValidator[searchParams](),
	"notion.update_page": makeParamValidator[updatePageParams](),
}
