...
func (c *PagerDutyConnector) ValidateParams(actionType string, params json.RawMessage) error {
...
var paramValidators = map[string]connectors.ParamValidatorFunc{
	"pagerduty.acknowledge_alert": makeParamValidator[acknowledgeAlertParams](),
	"pagerduty.add_note": makeParamValidator[addNoteParams](),
	"pagerduty.create_incident": makeParamValidator[createIncidentParams](),
	"pagerduty.escalate_incident": makeParamValidator[escalateIncidentParams](),
	"pagerduty.resolve_incident": makeParamValidator[resolveIncidentParams](),
}
