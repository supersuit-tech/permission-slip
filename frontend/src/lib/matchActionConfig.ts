...
/**
 * True when execution parameters satisfy an action configuration's parameter constraints.
 * Mirrors backend ValidateParametersAgainstConfig for client-side config attribution.
 */
