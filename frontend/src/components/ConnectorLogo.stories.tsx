...
const meta: Meta<typeof ConnectorLogo> = {
...
export const GoogleSmall: Story = {
  args: { name: "Google", logoSvg: GOOGLE_LOGO, size: "sm" },
};

export const GoogleMedium: Story = {
  args: { name: "Google", logoSvg: GOOGLE_LOGO, size: "md" },
};

export const GoogleLarge: Story = {
  args: { name: "Google", logoSvg: GOOGLE_LOGO, size: "lg" },
};

export const GitHubLarge: Story = {
  args: { name: "GitHub", logoSvg: GITHUB_LOGO, size: "lg" },
};

export const SlackLarge: Story = {
  args: { name: "Slack", logoSvg: SLACK_LOGO, size: "lg" },
};

export const FallbackInitials: Story = {
  args: { name: "Custom Connector", size: "lg" },
};

export const FallbackSingleWord: Story = {
  args: { name: "Stripe", size: "lg" },
};

export const FallbackNoName: Story = {
  args: { name: "", size: "lg" },
};
