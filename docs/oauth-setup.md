...
Permission Slip uses OAuth 2.0 to connect with Google, Microsoft, PagerDuty, Meta (Facebook/Instagram), and X (Twitter) services. This guide covers how to configure OAuth for both hosted and self-hosted deployments.
